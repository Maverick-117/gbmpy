...
if use_muQ:
    width, height = 0.2, 0.2;# 7: 0.15, 0.15
    ...
    #xi3*U[0]/(1+xi3*U[0])
        ...
        figFdbk, axFdbk = plt.subplots(ncols=2, nrows=1, figsize=(20, 10),
                                constrained_layout=True)
        figDftn, axDftn = plt.subplots(ncols=2, nrows=1, figsize=(20, 10),
                                constrained_layout=True)
        figNetDiv, axNetDiv = plt.subplots(ncols=1, nrows=1, figsize=(10, 10),
                                constrained_layout=True)
